<?php
	...
	if(checkToken()){
		...
		?>
			...
			<div class="row">
		 		<div class="col-sm-12">
		 			<h3 class="viewTitle">Edit Final Draft</h3>
		 		</div>
		 	</div>
					...
					<form id="eventDraftForm">
						...
						<div class="row">
					 		<div class="form-group col-sm-12">
					 			...
					 			<?php if(userHasClearance(3, $userTypes)){ echo '<button style="margin-right:15px;"  type="submit" class="btn btn-success pull-right submit" data-ctrl="editFinalDraft">Update</button>';}?>
							</div>
						</div>
					</form>
				</div>
